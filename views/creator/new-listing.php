                        ...
                        <div class="row row-deck text-center">
                            <div class="col-sm-6 col-lg-4 mb-3">
                                <div class="card card-custom" style="background-color: #F4F4F4;">
                                    <a href="new-listing.php?type=scratch" class="text-decoration-none">
                                        <div class="card-body">
                            ...
                            <div class="col-sm-6 col-lg-4 mb-3">
                                <div class="card card-custom" style="background-color: #F3FAF4;">
                                    <a href="new-listing.php?type=digital" class="text-decoration-none">
                                        <div class="card-body">
                            ...
                            <div class="col-sm-6 col-lg-4 mb-3">
                                <div class="card card-custom" style="background-color: #FFFEF3;">
                                    <a href="new-listing.php?type=instagram" class="text-decoration-none">
                                        <div class="card-body">
                            ...
                            <div class="col-sm-6 col-lg-4 mb-3">
                                <div class="card card-custom" style="background-color: #F9F2FA;">
                                    <a href="new-listing.php?type=zoom" class="text-decoration-none">
                                        <div class="card-body">
                            ...
                            <div class="col-sm-6 col-lg-4 mb-3">
                                <div class="card card-custom" style="background-color: #E8EAF6;">
                                    <a href="new-listing.php?type=event" class="text-decoration-none">
                                        <div class="card-body">
                            ...
                            <div class="col-sm-6 col-lg-4 mb-3">
                                <div class="card card-custom" style="background-color: #E3F2FD;">
                                    <a href="new-listing.php?type=physical" class="text-decoration-none">
                                        <div class="card-body">
