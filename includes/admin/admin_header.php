            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="explore-creators.php">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <!-- Users/Explore icon -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="payout-settings.php">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <!-- Money/Cash icon -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div class="white-background">
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                                        ...
                                        <span class="avatar avatar-rounded avatar-sm" style="background-image: url(../../assets/img/karl_image.png)"></span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        <a href="#" class="dropdown-item">View my page</a>
                                        <a href="#" class="dropdown-item">Dashboard</a>
                                        <a href="#" class="dropdown-item">My account</a>
                                        <div class="dropdown-divider"></div>
                                        <a href="#" class="dropdown-item">Refer a creator</a>
                                        <a href="#" class="dropdown-item">What's New</a>
